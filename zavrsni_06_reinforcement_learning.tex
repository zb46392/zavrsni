...
Ova klasa naslijeđena je od bazne klase \pythoninline{Base} koja je apstraktna klasa dana u ispisu~\ref{q_learning_base_class}. Definira potpis metode \pythoninline{observe_environment}, \pythoninline{choose_action} te \pythoninline{prepare_for_episode}. 
...
\fi
Ova implementacija q-učenja očekuje okruženje \pythoninline{ObservableEnvironment} što je jako jednostavna klasa vidljiva u ispisu~\ref{q_learning_observable_environment}, a sadrži tri podatka a to su stanje, nagrada i da li je posljedno stanje u epizodi.
